...
public class RelationshipTypeIsMarriageSpecification implements Specification<RelationshipEntity> {
    @Override
    public Predicate toPredicate
            (Root<RelationshipEntity> root, CriteriaQuery<?> query, CriteriaBuilder builder){
        return builder.equal(root.get("type"), RelationshipType.MARRIAGE);
    }
}
